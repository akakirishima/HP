...
export const translations: Record<Language, Record<TranslationKeys, string>> = {
    ja: {
        ...
        nav_language: '言語',
        loading: '読み込み中...',
        footer_copyright: '© {year} akakirisima. All Rights Reserved.',
    },
    en: {
        site_title: 'akakirisima',
        nav_home: 'Home',
    ...
    ko: {
        ...
        nav_language: '언어',
        loading: '로딩 중...',
        footer_copyright: '© {year} akakirisima. 모든 권리 보유.',
    },
    zh: {
        site_title: 'akakirisima',
        nav_home: '首页',
        ...
        nav_language: '语言',
        loading: '加载中...',
        footer_copyright: '© {year} akakirisima. 保留所有权利。',
    }
};
